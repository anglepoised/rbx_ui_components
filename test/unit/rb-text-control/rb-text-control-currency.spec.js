define([
    ...
    './rb-text-control-currency.tpl.html'
    ...
    describe('rb-text-control', function () {
        ...
        describe('root element', function () {
            it('should have the TextControl--currency class', function () {
                expect(element.find('div').hasClass('TextControl--currency')).toBe(true);
            });
        });
        ...
        describe('currency validation', function () {
            ...
            describe('message', function () {
                it('should show when currencty invalid after touch', function () {
