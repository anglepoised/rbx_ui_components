define([
    ...
    describe('rg-text-control', function () {
        ...
        describe('root element', function () {
            it('should have the RgTextControl--text class', function () {
                expect(element.find('div').hasClass('RgTextControl--text')).toBe(true);
            });

            it('should have RgTextControl--small class when `small` is `true`', function () {
                element = $compile('<rg-text-control small="true"></rg-text-control>')($scope);
                $scope.$apply();
                expect(element.hasClass('RgTextControl--small')).toBe(true);
            });

            it('should not have RgTextControl--small class when `small` is `false`', function () {
                element = $compile('<rg-text-control small="false"></rg-text-control>')($scope);
                $scope.$apply();
                expect(element.hasClass('RgTextControl--small')).toBe(false);
            });

            it('should not have RgTextControl--small class when `small` is undefined', function () {
                element = $compile('<rg-text-control></rg-text-control>')($scope);
                $scope.$apply();
                expect(element.hasClass('RgTextControl--small')).toBe(false);
            });
        });
        ...
        describe('help message', function () {
            it('should show and contain help message when set', function () {
                ...
                element = angular.element(element[0].querySelector('.RgTextControl-message'));
