define([
    ...
    describe('rb-badge', function () {
        ...
        describe('with state', function () {
            ...
            it('should be a warning badge if warning state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should be a statusIncomplete badge if statusIncomplete state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should be a statusLive badge if statusLive state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should be a statusPending badge if statusPending state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should be a statusPaused badge if statusPaused state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should be a statusFinished badge if statusFinished state attr is supplied and set correct details', inject(function ($compile, $rootScope) {
            ...
            it('should have no state or body class if state is not recognised', inject(function ($compile, $rootScope) {
                var badge = angular.element('<rb-badge state="custom"></rb-badge>'),
                    element = $compile(badge)($rootScope.$new());

                $rootScope.$apply();
                expect(badge.hasClass('Badge--custom')).toBe(false);
                expect(angular.element(element.find('span')[1]).text()).toBe('');
            }));
        ...
        describe('with body', function () {
            ...
            it('should take body from attribute', inject(function ($compile, $rootScope) {
                var badge = angular.element('<rb-badge body="6"></rb-badge>'),
                    element = $compile(badge)($rootScope.$new());
